...
public class LeaveController {
    ...
    public ResponseEntity<ApiResponseBody<LeaveResponse>> createLeaveRequest(
    ...
    public ResponseEntity<ApiResponseBody<Page<LeaveResponse>>> getMyLeaveRequests(
            @Parameter(hidden = true) @AuthenticationPrincipal EmployeeUserDetails user,
            Pageable pageable
    ) {
    ...
    public ResponseEntity<ApiResponseBody<LeaveResponse>> getLeaveRequestById(
            @Parameter(hidden = true) @AuthenticationPrincipal EmployeeUserDetails user,
    ...
    public ResponseEntity<ApiResponseBody<Page<LeaveResponse>>> getAllLeaveRequests(
            Pageable pageable
    ) {

        return ResponseEntity.ok(
                ApiResponseBody.success(leaveService.getAllLeaveRequests(pageable))
        );
    }
    ...
    public ResponseEntity<ApiResponseBody<Page<LeaveResponse>>> getLeaveRequestsByStatus(
    ...
    public ResponseEntity<ApiResponseBody<LeaveResponse>> updateLeaveRequest(
            @Parameter(hidden = true) @AuthenticationPrincipal EmployeeUserDetails user,
            @Parameter(description = "Leave request ID") @PathVariable Long leaveRequestId,
    ...
    public ResponseEntity<ApiResponseBody<LeaveResponse>> approveLeaveRequest(
            @Parameter(hidden = true) @AuthenticationPrincipal EmployeeUserDetails user,
            @Parameter(description = "Leave request ID") @PathVariable Long leaveRequestId,
    ...
    public ResponseEntity<ApiResponseBody<Void>> deleteLeaveRequest(
            @Parameter(hidden = true) @AuthenticationPrincipal EmployeeUserDetails user,
            @Parameter(description = "Leave request ID") @PathVariable Long leaveRequestId
    ) {
        ...
        return ResponseEntity.ok(
                ApiResponseBody.success(null, "Leave request deleted successfully")
        );
    }
}