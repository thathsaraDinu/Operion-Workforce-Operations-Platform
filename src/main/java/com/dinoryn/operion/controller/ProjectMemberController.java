...
public class ProjectMemberController {
    ...
    public ResponseEntity<ApiResponseBody<ProjectMemberResponse>> addMember(
    ...
    public ResponseEntity<ApiResponseBody<Page<ProjectMemberResponse>>> getProjectMembers(
            @Parameter(description = "Project ID") @PathVariable Long projectId,
            Pageable pageable
    ) {
    ...
    public ResponseEntity<ApiResponseBody<Void>> removeMember(
            @Parameter(description = "Project ID") @PathVariable Long projectId,
        ...
        return ResponseEntity.ok(
                ApiResponseBody.success(null, "Member removed successfully")
        );
    }
}